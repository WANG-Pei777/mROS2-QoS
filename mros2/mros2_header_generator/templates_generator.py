...
def main():
    global pubMsgTypes, subMsgTypes, includeFiles
    ...
    # Deduplicate message types with a set.
    pubMsgTypes = list(set(pubMsgTypes))
    subMsgTypes = list(set(subMsgTypes))
    ...
    includeFiles = list(set(includeFiles))
