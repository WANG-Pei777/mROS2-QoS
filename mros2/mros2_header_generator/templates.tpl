...
template mros2::Publisher mros2::Node::create_publisher<{{pubMsgType}}>(std::string topic_name, const mros2::QoSProfile& qos);
template void mros2::Publisher::publish({{pubMsgType}} &msg);
{% endfor %}

{% for subMsgType in subMsgTypes %}
template mros2::Subscriber mros2::Node::create_subscription(std::string topic_name, const mros2::QoSProfile& qos, void (*fp)({{subMsgType}}*));
